export const links = [
  ...
  { path: '/students-page', label: "Student's page", roles: ['admin', "teacher", "student", "noClassAssigned"] },
  { path: '/speaking-corrections', label: 'Speaking corrections', roles: ['admin', "teacher", "student", "noClassAssigned"] },
